...
public class Deployments {
    ...
    private static final String SOLDER_API_JAR = "../api/target/solder-logging-api.jar";
    private static final String SOLDER_IMPL_JAR = "../impl/target/solder-logging-impl.jar";
    private static final String SOLDER_LOGGING_JAR = "../../logging-internal/target/solder-logging-internal.jar";
